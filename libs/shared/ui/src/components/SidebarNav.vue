<template>
  <div class="w-full transition-all duration-500" :class="[collapsed ? 'max-w-20' : 'max-w-64']">
    <div class="border border-border h-screen overflow-y-auto sticky top-0">
      ...
      <aside
        :class="[
          'z-40 flex h-full flex-col gap-4 border-l border-border bg-surface px-3 py-4 transition-all lg:translate-x-0',
